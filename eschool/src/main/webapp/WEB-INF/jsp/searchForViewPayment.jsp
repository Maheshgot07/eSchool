...
<div class="container">
<p>Search Student</p>
<form:form action="executeViewPaymentSearch.html" method="post" modelAttribute="searchWrapper" enctype="multipart/form-data">
<table style="100%" width="90%">
<tr>
<td><label for="lbl"><b>Roll Num</b></label></td>
<td><input type="text" placeholder="Search By rollNum" name="searchStudent.rollNum" id="rollNum" value = ${searchWrapper.searchStudent.rollNum}></td>

<td><label for="lbl"><b>First Name</b></label></td>
<td><input type="text" placeholder="Search FirstName" name="searchStudent.firstName" value = ${searchWrapper.searchStudent.firstName}></td>
<td><label for="lbl"><b>Last Name</b></label></td>
<td><input type="text" placeholder="Search LastName" name="searchStudent.lastName" value = ${searchWrapper.searchStudent.lastName}><br></td>
</tr>
<tr>
...
<button type="submit" value="search" class="registerbtn">Search</button>
</form:form>


<div class="container">
<div>
	<c:if test="${!empty searchWrapper.studentsList}">
 ...
 <table id="tbl1"  >
  ...
  <c:forEach items="${searchWrapper.studentsList}" var="std">
   <tr>
    <td><a href="viewPayment.html?id=${std.id}" ><c:out value = "${std.rollNum}"/></a></td>
    <td><c:out value = "${std.firstName} ${std.lastName}"/></td>
    <td><c:out value = "${std.standard}"/></td>
    <td><c:out value = "${std.division}"/></td>
    <td><c:out value = "${std.academicYr}"/></td>
	</tr>
  </c:forEach>
 </table>
</c:if>
