...
<div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="initSearch.html">Search Students</a>
    </div>
  </div> 
 ...
 <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="searchStudentForPayment.html">new Payment</a>
      <a href="searchStudentForViewPayment.html">View Payment</a>
      
    </div>
  </div> 
  <div class="dropdown">
    <button class="dropbtn">Conifiguration 
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
      <a href="initFeeStructure.html">FeeStucture</a>
    </div>
  </div> 
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="exportInit.html">Export Students</a>
      <a href="exportPaymentInit.html">Export Payment</a>
